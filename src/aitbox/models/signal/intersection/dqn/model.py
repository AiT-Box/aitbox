...
class Model:
    ...
    def __init__(  # noqa: PLR0913
        ...
        if model_path and (model_path / model_name).exists():
            model_file = model_path / model_name
            print(f"Loading trained model for the Agent from {model_file}")
    ...
    def save_model(self, out_path: Path, model_name:str) -> None:
        """Save the model to ``out_path / model_name``."""
        out_path.mkdir(parents=True, exist_ok=True)
        torch.save(self.model, out_path / model_name)
